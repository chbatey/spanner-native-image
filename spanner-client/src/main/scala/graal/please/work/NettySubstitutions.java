...
//@TargetClass(className = "akka.grpc.internal.NettyClientUtils")
//final class Target_akka_grpc_internal_NettyClientUtils {
//    @Substitute
//    private static SslContext nettyHttp2SslContext(SSLContext context) {
//
//        return null;
//    }
//}
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.JdkSslServerContext")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.JdkSslClientContext")
...
/*
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.SslHandler$SslEngineType")
...
final class Target_io_nrpc_netty_GrpcSslContexts{
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.JdkAlpnApplicationProtocolNegotiator$AlpnWrapper", onlyWith = JDK11OrLater.class)
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.JdkAlpnApplicationProtocolNegotiator$AlpnWrapper", onlyWith = JDK8OrEarlier.class)
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.JettyAlpnSslEngine", onlyWith = JDK8OrEarlier.class)
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.Java9SslEngine", onlyWith = JDK11OrLater.class)
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.JdkDefaultApplicationProtocolNegotiator")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.handler.ssl.JdkSslContext")
 ...
 */
@TargetClass(className = "io.grpc.netty.shaded.io.netty.bootstrap.AbstractBootstrap")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.util.concurrent.ScheduledFutureTask")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.channel.ChannelHandlerMask")
...
@TargetClass(className = "io.grpc.netty.shaded.io.netty.util.internal.NativeLibraryLoader")
